...
type Config struct {
	IsOnlyCloudflareProxy bool `json:"isOnlyCloudflareProxy,omitempty" toml:"isOnlyCloudflareProxy,omitempty" yaml:"isOnlyCloudflareProxy,omitempty"`
...
func New(ctx context.Context, next http.Handler, config *Config, name string) (http.Handler, error) {
	ipOverWriter := &RealIPOverWriter{
		next:                  next,
		name:                  name,
		IsOnlyCloudflareProxy: config.IsOnlyCloudflareProxy,
	}
